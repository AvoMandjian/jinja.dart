  ...
  group('Nodes toJson and toSource coverage', () {
    ...
    test('Statement nodes', () {
      final nodes = [
        ...
        For(
            target: const Name(name: 'i', context: AssignContext.store),
            iterable: const Constant(value: []),
            body: const Data()),
        If(
            test: const Constant(value: true),
            body: const Data(),
            orElse: const Data()),
        ...
        const FromImport(
            template: Constant(value: 'm.html'), names: [('a', 'b')]),
        Do(value: const Constant(value: 1)),
        TryCatch(body: const Data(), catchBody: const Data()),
        Assign(
            target: const Name(name: 'x', context: AssignContext.store),
            value: const Constant(value: 1)),
