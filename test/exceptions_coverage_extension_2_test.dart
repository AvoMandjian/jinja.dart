...
void main() {
  group('Jinja Exceptions Coverage Extensions', () {
    test('TemplateNotFound toString', () {
      final err1 =
          TemplateNotFound(name: 'a.html', searchPaths: ['/tmp', '/var']);
    ...
    test('TemplateSyntaxError toString', () {
      final err1 =
          TemplateSyntaxError('msg', path: 'a.html', line: 1, column: 2);
      final str1 = err1.toString();
      expect(str1, contains("file 'a.html'"));
      expect(str1, contains('line 1, column 2'));

      final err2 = TemplateSyntaxError('msg',
          templatePath: 'b.html', node: Name(name: 'x', line: 10));
    ...
    test('UndefinedError toString', () {
      final err = UndefinedError('msg',
          variableNameValue: 'foo', similarNamesValue: ['food', 'fool']);
